...
const LoginPage = () => {
  return (
    <div className='mt-[9vh] flex items-center justify-center min-h-[75vh]'>
        <div className='mt-10 bg-gray-700 lg:px-[180px] lg:py-[200px] flex flex-col gap-[100px] mb-10 rounded-md md:px-[50px] md:py-[100px] 2xs:px-10 2xs:py-10 3xs:px-5 3xs:py-5'>
